...
| `CLAUDE_MEM_OPENROUTER_MODEL`                | `nvidia/nemotron-3-nano-30b-a3b:free` | Primary model id |
| `CLAUDE_MEM_OPENROUTER_MODEL_FALLBACKS`      | `nvidia/nemotron-nano-9b-v2:free,google/gemma-4-31b-it:free` | Comma-separated ids; used on 429/405 |
